...
const SidebarProvider: Component<SidebarProviderProps> = (rawProps) => {
  ...
  const setOpen = (value: boolean | ((value: boolean) => boolean)) => {
    ...
    // TODO: Cookie “sidebar:state” does not have a proper “SameSite” attribute value. Soon
          ...
          <div
            class={cn(
              ...
              local.variant === "floating" || local.variant === "inset"
                ...
                : "border-border group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)] group-data-[side=left]:border-r group-data-[side=right]:border-l",
              local.class,
            )}
            {...others}
          >
